...
# model_performance(ols_models[[vars_lst[6]]])
# check_collinearity(ols_models[[vars_lst[6]]])
# check_model(ols_models[[vars_lst[6]]])
...
sem_models <- readRDS(here(T3_30_300_DIR, "models_new", "sem_models.rds"))
slm_models <- readRDS(here(T3_30_300_DIR, "models_new", "slm_models.rds"))
